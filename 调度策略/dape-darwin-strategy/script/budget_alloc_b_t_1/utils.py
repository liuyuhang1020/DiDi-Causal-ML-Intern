...
def validate_input(argument):
	...
	argu['ext_data'] = json.loads(argu['ext_data'])
	if not argu['ext_data']['artificial']:
		argu['ext_data']['artificial'] = []
	if not argu['ext_data']['budget_limit']:
		argu['ext_data']['budget_limit'] = []
	print(argu)
